...
class DoctorsFilterBarWidget extends StatefulWidget {
  const DoctorsFilterBarWidget({
    super.key,
  ...
  @override
  State<DoctorsFilterBarWidget> createState() =>
      _DoctorsFilterBarWidgetState();
}

class _DoctorsFilterBarWidgetState extends State<DoctorsFilterBarWidget> {
  ...
  void initState() {
    super.initState();
    _searchController =
        TextEditingController(text: widget.nameFilter.value);
  }
...
class _BranchDropdown extends StatelessWidget {
  const _BranchDropdown(
      {required this.branchFilter, required this.branches});
      ...
      builder: (context, value, _) {
        return DropdownButtonFormField<String?>(
          ...
          decoration: _dropdownDecoration(
              'الفرع', Icons.location_city_rounded),
...
class _SpecialtyDropdown extends StatelessWidget {
  const _SpecialtyDropdown(
      {required this.specialtyFilter, required this.specialties});
        ...
        return DropdownButtonFormField<String?>(
          ...
          items: [
            const DropdownMenuItem(
                value: null, child: Text('كل التخصصات')),
            ...specialties.map(
